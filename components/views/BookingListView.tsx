    ...
    return (
        <div>
            {upcomingBookings.length === 0 ? (
                <div className="text-center p-10 bg-brand-primary rounded-lg text-brand-text">ไม่มีข้อมูลการจองล่วงหน้า</div>
            ) : (
                        ...
                        <div key={b.id} className="bg-brand-primary rounded-lg shadow-lg p-3 flex justify-between items-center">
                            ...
                            <div className="flex items-center gap-2 ml-4">
                                ...
                                <button
                                    ...
                                    className="bg-green-600 hover:bg-green-700 text-white font-bold py-2 px-4 rounded-md transition-colors text-sm whitespace-nowrap"
                                >
                                    เช็คอิน
                                </button>
                            </div>
